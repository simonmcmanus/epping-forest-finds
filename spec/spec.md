...
- **Default filters:** On first visit, **Trees**, **Cows**, and **Pubs & bars** are pre-selected in the onboarding chip screens. All other subfilters start deselected. If onboarding is skipped without changes, only these three are active.
