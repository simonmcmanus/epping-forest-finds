...
function handleEdited() {
  ...
  const prompt = [
    ...
    '- "annotated": the previous questions comment, updated so that each numbered question',
    '  has an emoji prefix and, on the next line(s), a blockquote summarising the answer',
    '  drawn from the replies. Format each question block like this:',
    '  ✅ 1. The original question text?',
    '  > One or two sentences capturing the answer from the replies.',
    '  Use these emojis:',
    '  ✅ clearly and fully answered',
    '  💬 partially answered or needs more detail',
    '  ❓ not yet answered — omit the blockquote for unanswered questions',
    '  Do not change the intro line.',
