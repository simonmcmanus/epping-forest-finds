...
- Name: 03-selection.spec.js >> Selection and Inspector >> inspector state when location is selected >> inspector back button is visible in selected-detail mode
- Location: test/e2e/03-selection.spec.js:81:5
