...
- Name: 03-selection.spec.js >> Selection and Inspector >> tree search panel >> tree search toggle reveals the search input
- Location: test/e2e/03-selection.spec.js:57:5
