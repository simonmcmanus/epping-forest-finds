...
- Name: 03-selection.spec.js >> Selection and Inspector >> returning to overview >> URL hash is cleared when returning to overview
- Location: test/e2e/03-selection.spec.js:45:5
...
Call log:
  - waiting for locator('#nearbyToggle')
    - locator resolved to <button type="button" id="nearbyToggle" aria-label="Back to nearby" class="close nearby-toggle screen-active">…</button>
