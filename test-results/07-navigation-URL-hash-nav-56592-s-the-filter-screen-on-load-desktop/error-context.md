...
- Name: 07-navigation.spec.js >> URL hash navigation >> hash #filters >> navigating to /#filters opens the filter screen on load
- Location: test/e2e/07-navigation.spec.js:7:5
