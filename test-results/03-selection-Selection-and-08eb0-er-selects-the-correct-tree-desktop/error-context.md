...
- Name: 03-selection.spec.js >> Selection and Inspector >> tree search panel >> searching by tree number selects the correct tree
- Location: test/e2e/03-selection.spec.js:63:5
