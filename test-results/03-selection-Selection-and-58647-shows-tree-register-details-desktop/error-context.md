...
- Name: 03-selection.spec.js >> Selection and Inspector >> tree selected via URL hash >> inspector body shows tree register details
- Location: test/e2e/03-selection.spec.js:19:5
...
Locator: locator('#inspectorBody')
Expected substring: "11383"
Received string:    "Could not fully load map data. Try a hard refresh. If running locally, make sure the server is started from this folder."
Timeout: 5000ms

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('#inspectorBody')
    14 × locator resolved to <div id="inspectorBody" class="inspector-body">…</div>
       - unexpected value "Could not fully load map data. Try a hard refresh. If running locally, make sure the server is started from this folder."
