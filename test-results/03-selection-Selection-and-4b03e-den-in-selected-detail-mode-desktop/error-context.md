...
- Name: 03-selection.spec.js >> Selection and Inspector >> inspector state when location is selected >> filter button is hidden in selected-detail mode
- Location: test/e2e/03-selection.spec.js:77:5
