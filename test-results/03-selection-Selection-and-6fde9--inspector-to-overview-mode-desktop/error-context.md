...
- Name: 03-selection.spec.js >> Selection and Inspector >> returning to overview >> back button returns inspector to overview mode
- Location: test/e2e/03-selection.spec.js:39:5
