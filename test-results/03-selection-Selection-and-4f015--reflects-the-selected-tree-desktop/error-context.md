...
- Name: 03-selection.spec.js >> Selection and Inspector >> tree selected via URL hash >> URL hash reflects the selected tree
- Location: test/e2e/03-selection.spec.js:24:5
...
Expected pattern: /tree=11383/
Received string:  "http://localhost:8080/"
Timeout: 5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    14 × unexpected value "http://localhost:8080/"
