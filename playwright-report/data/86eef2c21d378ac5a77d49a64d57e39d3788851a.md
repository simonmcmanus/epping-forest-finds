...
- Location: test/e2e/03-selection.spec.js:95:5
...
Call log:
  - waiting for locator('#treeSearchButton')
...
- main [ref=e3]:
  ...
  - text: "!"
  - button "Show tree search" [expanded] [ref=e6] [cursor=pointer]: 🔍
  - complementary [ref=e7]:
    ...
    - generic [ref=e16]:
      - generic [ref=e17]:
        - searchbox "Search by tree number" [active] [ref=e18]: "11383"
